function glCanvas(canvas,options) {
  // Flutter owns this canvas through HtmlElementView. Appending it directly to
  // document.body creates a second, full-page WebGL layer that blacks out the
  // desktop background and survives route transitions. Keep it detached until
  // Flutter mounts the registered platform view, and make its CSS box follow
  // that view rather than its high-DPI backing-store dimensions.
